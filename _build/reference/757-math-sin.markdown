...
SIN and COS use radians for angle measure, just use the RAD function to convert an angle in degrees to radians. Radians are circle measures based on pi instead of degrees.
...
Here is a demo of cool stuff you can do with SIN and COS:
...
for degree=0 to 360 step 10   'zero is due East
  ...
  if degree=0 then
    print " 0 degrees don't worry, you haven't seen nothing yet! press any...
  else
    print degree;" degrees press any..."
  end if
...
here as the degrees increase so did the extension out which cause the spiral effect. The COS calculation was used for x "the run" or horizontal component and the SIN calculation was used for y "the rise" or vertical component. This is really, really important to use and play with even if you don't understand all the details, the code will serve you well. Still I did my best to explain how this works, so it is a bit wordy...
